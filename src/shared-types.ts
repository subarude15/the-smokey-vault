// Shared types and constants that can be safely imported by both client and server
// This file MUST NOT import any server-side modules (db, fs, etc.)
...
// Re-export restock shared types
export {
  type RestockKind,
  type WantedLabel,
  type WantedRow,
