...
12. **PR147 — Visual system / Smokey Barrel branding polish** (done)
   ...
   - Typography pairing via tokens (`--font-display`/`--font-serif`/`--font-sans`): a readable blackletter (`Grenze Gotisch`) is used only for brand moments and major headers (hero wordmark, page titles, section/feature/empty/modal headings); Playfair Display stays for content titles (product/cocktail names) and Outfit for all body/controls/metadata.
