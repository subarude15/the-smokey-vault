...
- PR149–PR154 product-polish items are complete. **PR155** adds cocktail image discovery observability + French 75 production reliability (SERP pre-filter false negatives; Keeper diagnostics; SearXNG health remains connectivity-only). Next: **PR156 — Bottle Library flavor data audit + facet reliability** (not started).
