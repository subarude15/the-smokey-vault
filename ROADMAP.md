...
21. **PR160 — Interface Depth & Motion System** (ready for review)
   ...
   - **Acceptance:** At rest, content cards are obviously above the page on Light and Dark; hover-capable cards rise unmistakably (~8–9px) with deeper/wider shadow; touch controls depress slightly and return cleanly; panels stay quieter than cards; overlays sit above hovered cards; homepage wordmark/filigree remain non-card layered planes; filtering/navigation transitions stay short and non-blocking; warm accent bounce-light stays atmospheric (not a glow border); no persistent/distracting motion; Light/Dark and mobile-first behavior preserved; focused PR160 tests, full suite, and production build pass.
